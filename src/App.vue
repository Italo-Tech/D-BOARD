...
export default {
  ...
  computed: {
      ...mapState([
        'dBoard','isCube','isCog','isExplore','isApps','isMenu','isMenu1','isMenu2','isMenu3','isDemos','isNation','isCube','isProjectStatus','isProfile','isSettings','isConversions','isConversions2','isUIElement'
      ]),
  },
  beforeMount () {
    this.fillData()
