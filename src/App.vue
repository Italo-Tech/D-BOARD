        ...
        <div class="wrapper">
          ...
          <div v-show="this.$store.state.dBoard" class="left-sidebar left-sidebar-1 trs-left-to-right">
            ...
            <div class="logo truncate">
              ...
              <button class="ml-auto mr-4 block lg:hidden">
          ...
          <div class="main w-full bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-white">
            ...
            <!--            <div class="navbar navbar-1 border-b">
              <div class="navbar-inner  w-full flex items-center justify-start">
                      ...
                      <div class="flex flex-col">
                        ...
                        <div class="flex flex-col p-2 dropdown-item">
                          <div class="flex items-center justify-between mb-2">
                            ...
                            <div class="text-xs whitespace-nowrap">33&lt;!&ndash; &ndash;&gt;%</div>
                          </div>
                        ...
                        &lt;!&ndash;Deploy Github&ndash;&gt;
                        <div class="flex flex-col p-2 dropdown-item">
                          <div class="flex items-center justify-between mb-2">
                            <div class="text-sm font-bold">Deploy Github</div>
                            <div class="text-xs whitespace-nowrap">50&lt;!&ndash; &ndash;&gt;%</div>
                          </div>
                        ...
                        <div class="flex flex-col p-2 dropdown-item">
                          <div class="flex items-center justify-between mb-2">
                            ...
                            <div class="text-xs whitespace-nowrap">66&lt;!&ndash; &ndash;&gt;%</div>
                          </div>
                        ...
                        &lt;!&ndash;Banco de Dados Backup&ndash;&gt;
                        <div class="flex flex-col p-2 dropdown-item">
                          <div class="flex items-center justify-between mb-2">
                            <div class="text-sm font-bold">Backup DB</div>
                            <div class="text-xs whitespace-nowrap">25&lt;!&ndash; &ndash;&gt;%</div>
                          </div>
                        ...
                        <div class="flex flex-col p-2 dropdown-item">
                          <div class="flex items-center justify-between mb-2">
                            <div class="text-sm font-bold">Backup DB</div>
                            <div class="text-xs whitespace-nowrap">80&lt;!&ndash; &ndash;&gt;%</div>
                          </div>
                ...
                &lt;!&ndash;BUTTON CONFIG&ndash;&gt;
                <button @click.prevent="settingsRight" class="btn-transparent flex items-center justify-center h-16 w-8 mx-4 focus:outline-none">
